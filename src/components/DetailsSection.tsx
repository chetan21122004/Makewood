              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div>
                  <input 
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-2 focus:border-transparent" 
                    required 
                  />
                </div>
                ...
                <div>
                  <button 
                    type="submit" 
                    className="w-full px-6 py-3 text-white hover:bg-gray-600 text-white font-medium rounded-full transition-colors duration-300"
                  >
                    Request access
                  </button>
                </div>

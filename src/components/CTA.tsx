    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white relative" id="get-access" ref={ctaRef}>
      ...
      <div className="section-container relative z-10 opacity-0 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto glass-card p-6 sm:p-8 md:p-10 lg:p-14 text-center overflow-hidden relative">
          {/* Decorative circles */}
          <div className="absolute top-0 right-0 w-32 sm:w-40 h-32 sm:h-40 rounded-full translate-x-1/2 -translate-y-1/2 blur-2xl" style={{backgroundColor: 'rgba(122, 46, 29, 0.3)'}}></div>
          ...
          <div className="inline-flex items-center px-4 py-2 bg-gray-100 rounded-full text-sm font-medium mx-auto mb-4 sm:mb-6">
            <span style={{color: '#1C1C1C'}}>Limited Availability</span>
          </div>
          
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
            Be Among the First to <br className="hidden sm:inline" />
            <span style={{color: '#7A2E1D'}}>Transform Your Space</span>
          </h2>
          
          <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto">
Ready to create exceptional interiors? Contact us today to discuss your project and discover how Makewood can bring your vision to life.
          </p>
